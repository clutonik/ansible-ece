...
## Command to execute initial role to setup ansible user
```
ansible-playbook initial-play.yml -i inventory.yml --private-key=~/.ssh/id_rsa --extra-vars "ansible_sudo_pass=<your-ssh-password>"
```
